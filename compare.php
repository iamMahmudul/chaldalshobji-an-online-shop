...
if (isset($_GET['delcompare'])) {
		 $compareid=preg_replace('/[^-a-zA-Z0-9_]/', '',$_GET['delcompare']);
		 $delfromcompare=$product->delfromcompare($compareid);
	}
?>
  ...
  <div class="row">
    ...
    <div class="col-md-9">
      <div class="profiledetails">
        <h5><i class="fa fa-list"style="margin: 5px;color: red;"></i>Compared Products</h5>
        <table class="table table-striped table-responsive-md">
              ...
              <tr>
                ...
                <td width="15%"><a href="preview.php?proid=<?php echo $result['productid'];?>">View</a></td>
                 <td width="5%">
             <a href="?delcompare=<?php echo $result['productid'];?>">X</a>
                </td>
              </tr>
            <?php } } ?>  
            </table>
